...
struct Graphics {
    ...
    void loadMainScreen() {
    SDL_Texture* background = loadTexture("imgMenu/background.jpg");
    SDL_Texture* logo = loadTexture("imgMenu/logo.png");
    SDL_Texture* frame = loadTexture("frame.png");

    prepareScene(background);

    renderTexture(logo, 350, 50);

    renderTexture(frame, 290, 340);
    ...
    helloText = renderText("Life : ", font, color);
    renderTexture(helloText, 50, 450);
    }
